<?php
class ModelReportSaleOkTax extends Model {
	...
	public function getWebTotal($data = array()) {
    $sql = "select sum(t.value) as total from `" . DB_PREFIX . "order` o, `" . DB_PREFIX . "order_total` t
    where o.order_id = t.order_id and o.shipping_zone_id = 3660 
    and o.shipping_method = 'Download Only' and t.code in ('total')
    and o.order_paid = 1";
	...
	public function getShippedTotals($data = array()) {
    $sql = "select o.shipping_city, t.value, t.code from `" . DB_PREFIX . "order` o, `" . DB_PREFIX . "order_total` t
    where o.order_id = t.order_id and o.shipping_zone_id = 3660 
    and o.shipping_method <> 'Download Only' and t.code in ('shipping','sub_total')
    and o.order_paid = 1";
		...
		$sql .= " order by o.shipping_city, t.code";
		//exit($sql);
		$query = $this->db->query($sql);
