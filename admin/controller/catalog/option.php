...
class ControllerCatalogOption extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if (isset($this->request->get['featurecode'])) {
				$url .= '&featurecode=' . $this->request->get['featurecode'];
			}

	    if (isset($this->request->get['featurecodeOrder'])) {
				$url .= '&featurecodeOrder=' . $this->request->get['featurecodeOrder'];
			}
   ...
   if (isset($this->request->get['featurecodeOrder'])) {
      $url .= '&featurecodeOrder=' . $this->request->get['featurecodeOrder'];
		...
		foreach ($results as $result) {
			...
			$this->data['options'][] = array(
				...
				'featurecodeOrder' => $result['featurecodeOrder'],
		...
		$this->data['column_featurecode'] = $this->language->get('column_featurecode');
		$this->data['column_featurecodeOrder'] = $this->language->get('column_featurecodeOrder');
	...
	protected function getForm() {
		...
		$this->data['entry_featurecode'] = $this->language->get('entry_featurecode');
		$this->data['entry_featurecodeOrder'] = $this->language->get('entry_featurecodeOrder');
		...
		if (isset($this->request->post['featurecodeOrder'])) {
			$this->data['featurecodeOrder'] = $this->request->post['featurecodeOrder'];
		} elseif (!empty($option_info)) {
			$this->data['featurecodeOrder'] = $option_info['featurecodeOrder'];
		} else {
			$this->data['featurecodeOrder'] = '';
		}
