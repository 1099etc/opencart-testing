...
class ControllerCatalogSerial extends Controller {
	...
	private function getList() {
      ...
      //$this->data['featurecode'] = sprintf($this->model_catalog_serial->getFeatureCodeBySerial($serial));
		}
	...
	public function addOrderSerial() {
        ...
        $return['featurecode'] = $this->model_catalog_serial->generateFeatureCode($product_id);
        $return['keycode'] = $this->model_catalog_serial->generate_keycode($serial . $return['featurecode']);
			}
		}
  ...
  public function getFCBySerialKey($key) {
    $FC = $this->model_catalog_serial->getFeatureCodeByKey($key);
