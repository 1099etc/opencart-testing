...
class ControllerCommonHome extends Controller {   
    ...
    if($user_gid != '1') {
//      echo "<meta http-equiv='refresh' content='0;index.php?route=sale/order&token=" . $this->request->get['token'] . "' />";
      header("Location: index.php?route=sale/order&token=" . $this->request->get['token']);
      exit;
    }
