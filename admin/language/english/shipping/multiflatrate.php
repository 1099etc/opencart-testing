...
$_['entry_heading']					= 'Heading:<span class="help">Set the heading under which these shipping options will appear. HTML is supported.</span>';
$_['entry_sort_rates_by']			= 'Sort Rates By:';
$_['text_cost']						= 'Cost';
$_['text_order_entered']			= 'Order Entered';
...
$_['help_general_settings']			= '
	...
	Select the value used for percentage charges: the cart\'s Pre-Discounted Sub-Total (using all products\' original prices instead of Special or Discount prices), Sub-Total, Taxed Sub-Total, or Total (at the relative Sort Order of the "Shipping" Order Total). Products that do not require shipping are NOT included in the total.';
