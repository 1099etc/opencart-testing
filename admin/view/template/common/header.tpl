...
jQuery(document).ready(function() {
  ...
  jQuery(".expanderHeading").click(function()
  {
    jQuery(this).next(".expanderContent").slideToggle(500);
  });
});
</script>
...
<div id="header">
  <div class="div1">
    <div class="div2" style='vertical-align: middle' ><img src="view/image/logo.png" title="<?php echo $heading_title; ?>" onclick="location = '<?php echo $home; ?>'" style='vertical-align: middle' /><span style='font-size:15px; color: white; font-weight: bold; padding-left: 10px;'> | TEST ENVIRONMENT</span></div>
    <?php if ($logged) { ?>
