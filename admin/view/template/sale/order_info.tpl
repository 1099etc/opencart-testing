...
<?php
  if($alerts) {
?>
<div id="dialog" title="Alerts for Order ID -  <?php echo $order_id; ?>">

<?php 
  foreach($alerts as $a) {
?>
    <div class='alert severity_<?php echo $a['severity']; ?>' id="alert_<?php echo $a['alert_id']; ?>">
      <div class='alert_header severity_<?php echo $a['severity']; ?>'>
        <div class='alert_datetime severity_<?php echo $a['severity']; ?>'><?php echo date('j F Y - h:ia', strtotime($a['date_added'])); ?></div>
        <div class='alert_title severity_<?php echo $a['severity']; ?>'><?php echo $a['title']; ?></div>
      </div>
      <div class='alert_message severity_<?php echo $a['severity']; ?>'><?php echo $a['message']; ?></div>
    </div>
<?php
  } // end of foreach
?>
      ...
      <div id="tab-order" class="vtabs-content">
        <table class="form">
          ...
          <tr>
            ...
            <td><?php echo date("d M Y",strtotime(str_replace("/","-",$date_added))); ?></td>
          </tr>
          <tr>
            <td><?php echo $text_date_modified; ?></td>
            <td><?php echo date("d M Y",strtotime(str_replace("/","-",$date_modified))); ?></td>
          </tr>
          <tr>
            <td>Sales Agent:</td>
