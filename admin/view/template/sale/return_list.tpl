        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left"><?php echo date("d M Y", strtotime(str_replace("/","-",$return['date_added']))); ?></td>
              <td class="left"><?php echo date("d M Y", strtotime(str_replace("/","-",$return['date_modified']))); ?></td>
