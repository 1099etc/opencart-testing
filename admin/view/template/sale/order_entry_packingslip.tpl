...
<?php foreach ($orders as $order) { ?>
	<img src="<?php echo $order['store_logo']; ?>" alt="<?php echo $order['store_name']; ?>" width="300" height="45" />
	<div style="page-break-after: always;">
		...
		<!--<?php if ($order['comment']) { ?>
			<table style="border-collapse: collapse;width: 100%;margin-bottom: 20px;border-top: 1px solid #CDDDDD;border-right: 1px solid #CDDDDD;">
				<tr class="heading">
					<td style="background: #E7EFEF;border-left: 1px solid #CDDDDD;border-bottom: 1px solid #CDDDDD;padding: 5px;"><b>Comments</b></td>
				</tr>
				<tr>
					<td style="border-left: 1px solid #CDDDDD;border-bottom: 1px solid #CDDDDD;padding: 5px;><?php echo $order['comment']; ?></td>
				</tr>
			</table>
		<?php } ?>//-->
		<table style="border-collapse: collapse;width: 100%;margin-bottom: 20px;border-top: 1px solid #CDDDDD;border-right: 1px solid #CDDDDD;">
