	...
	<div class="content">
		<form action="" method="post" enctype="multipart/form-data" id="form">
			<table class="form" style="margin-bottom: -1px">
				...
				<tr>
					<td><?php echo $entry_sort_rates_by; ?></td>
					<td><select name="<?php echo $name; ?>_sort_rates">
							<option value="cost" <?php if (!empty(${$name.'_sort_rates'}) && ${$name.'_sort_rates'} == 'cost') echo 'selected="selected"'; ?>><?php echo $text_cost; ?></option>
							<option value="order" <?php if (!empty(${$name.'_sort_rates'}) && ${$name.'_sort_rates'} == 'order') echo 'selected="selected"'; ?>><?php echo $text_order_entered; ?></option>
						</select>
					</td>
				</tr>
			</table>
           ...
           <br />
           <div>
             <b>Description / Shipping Time</b><br />
             <input type='text' name='<?php echo $name; ?>_data[<?php echo $row; ?>][description]' size=30  value="<?php echo (!empty($rate['description']) && !empty($rate['description'])) ? $rate['description'] : ''; ?>" />
           </div>
					</td>
				<?php foreach ($order_criteria as $oc) { ?>
					<td class="center">
