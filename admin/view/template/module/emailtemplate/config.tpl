...
<link href="<?php echo $css_url; ?>" type="text/css" rel="stylesheet" />
		...
		<div class="content">
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
				...
				<table class="form">
					...
					<tr>
						<td>
							<label for="emailtemplate_config_theme"><?php echo $entry_style; ?></label>
						</td>
						<td>
	    		...
	    		<div class="tabsHolder">
	    			...
	    			<div id="editor-sections" class="vtabs-content">
	    				<table class="form">
							...
							<tr>
								<td>
									<label for="emailtemplate_config_showcase_section_bg_color"><?php echo $text_showcase; ?></label>
								</td>
								<td>
	    			...
	    			<div id="editor-invoice" class="vtabs-content tab-content-editor">
	    				<table class="form">
	    					...
	    					<tr>
								...
								<td>
									<input type="text" class="fieldColorPicker" name="emailtemplate_config_invoice_heading_color" value="<?php echo $emailtemplate_config['invoice_heading_color']; ?>" id="emailtemplate_config_invoice_heading_color" />
									<span style="background-color:<?php echo $emailtemplate_config['invoice_heading_color']; ?>;" class="colorPickerPreview">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input class="large" type="text" name="emailtemplate_config_invoice_title" id="emailtemplate_config_invoice_title" value="<?php echo $emailtemplate_config['invoice_title']; ?>" />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<textarea class="large" name="emailtemplate_config_invoice_text" id="emailtemplate_config_invoice_text"><?php echo $emailtemplate_config['invoice_text']; ?></textarea>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<div class="image">
										<img src="<?php echo $emailtemplate_config['invoice_logo_thumb']; ?>" alt="" id="thumb-invoice-logo" />
										<input type="hidden" name="emailtemplate_config_invoice_logo" value="<?php echo $emailtemplate_config['invoice_logo']; ?>" id="image-invoice-logo"  />
	                  					<br />
	                  					<a onclick="image_upload('image-invoice-logo', 'thumb-invoice-logo');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;
	                  					<a onclick="$('#thumb-invoice-logo').attr('src', '<?php echo $no_image; ?>'); $('#image-invoice-logo').attr('value', '');"><?php echo $text_clear; ?></a>
	                  				</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<input class="small" type="text" name="emailtemplate_config_invoice_logo_width" id="emailtemplate_config_invoice_logo_width" value="<?php echo $emailtemplate_config['invoice_logo_width']; ?>" />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input class="small" type="text" name="emailtemplate_config_invoice_products_limit" id="emailtemplate_config_invoice_products_limit" value="<?php echo $emailtemplate_config['invoice_products_limit']; ?>" />
								</td>
							</tr>
							<tr>
								<td>
    			...
    			<div class="tabsHolder tabsHolder-preview">	    			
	    			...
	    			<div id="preview-with" class="vtabs-content" style="padding: 10px 0">
	    				<?php echo $demo_html; ?>
	    			</div>
...
(function($){
	$(document).ready(function(){
		...
		$('#editor a').tabs(); // Editor tabs
		$('#preview a').tabs(); // Preview tabs

		CKEDITOR.replace('emailtemplate_config_head_text', {
		...
		CKEDITOR.replace('emailtemplate_config_page_footer_text', {
			filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
			filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
			filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
			filebrowserImageUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
		...
		CKEDITOR.replace('emailtemplate_config_footer_text', {
			filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
			filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
			filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
			filebrowserImageUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
		...
		CKEDITOR.replace('emailtemplate_config_invoice_text', {
			filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
			filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
			filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
			filebrowserImageUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
		...
		var $mediaIcons = $(".mediaIcons").children("span"),
			$previewArea =  $('#preview-with > table, #preview-without > table');
		$previewArea.each(function(){
		    this.style.setProperty('min-width', '0', 'important');
		    this.style.setProperty('margin', '0 auto', 'important');
		});
		
		$mediaIcons.click(function(){
			var $tis = $(this);
			$mediaIcons.removeClass('selected');
			$tis.addClass('selected');

			if($tis.hasClass('desktop')){
				$previewArea.each(function(){
				    this.style.setProperty('width', '100%', 'important');
				});
			} else if($tis.hasClass('tablet')){
				$previewArea.each(function(){
				    this.style.setProperty('width', '768px', 'important');
				});
			} else if($tis.hasClass('mobile')){
				$previewArea.each(function(){
				    this.style.setProperty('width', '320px', 'important');
				});
			}
