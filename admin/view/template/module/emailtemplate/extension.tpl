	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		<div class="box" id="emailtemplate">		
			<div class="heading">
				...
				<div class="buttons">
					<?php if(isset($upgrade_version) && $upgrade_version){ ?>
						<a href="<?php echo $upgrade_version; ?>" class="button"><span><?php echo strtoupper($text_upgrade); ?></span></a>
					...
					<?php } ?>
					<a href="<?php echo $docs_url; ?>" target="_blank" class="button button-secondary"><span><?php echo $text_docs; ?></span></a>
				...
				<div id="body-templates">			
			        ...
			        <table class="list" id="template_list">
						<thead>
							<tr>
								...
								<td class="left"><a href="<?php echo $sort_template; ?>" class="<?php if ($sort == 'template') echo strtolower($order); ?>"><?php echo $column_template; ?></a></td>
			              		<?php if($templates_type == ''){ ?><td class="center" width="80"><a href="<?php echo $sort_type; ?>" class="<?php if ($sort == 'type') echo strtolower($order); ?>"><?php echo $column_type; ?></a></td><?php } ?>
			            ...
			            <?php foreach ($templates as $template) { ?>
			            	<tr<?php if($template['action']){ ?> data-href="<?php echo $template['action']; ?>" style="cursor:pointer"<?php } ?>>
			              		...
			              		<?php if($templates_type == ''){ ?>
			              			<td class="center"><i><b><?php echo $template['type']; ?></b></i></td>
		              			<?php } ?>
			    	...
			    	<div class="pagination" style="text-align: center;">			
			    		...
			    		<div class="filter">
							...
							<label for="field_templates_type" style="font-style: italic;"><?php echo $entry_type; ?></label>								
							<select name="templates_type" id="field_templates_type" style="margin-right:15px; padding: 4px 3px; width:100px">
								<option value="">--- <?php echo $text_all; ?> ---</option>
								<?php foreach($emailtemplate_types as $value => $label){ ?>
									<option value="<?php echo $value; ?>"<?php if($templates_type == $value) echo ' selected="selected"'; ?>><?php echo $label; ?></option>
								<?php } ?>
							</select>
			...
			<div id="version-update" style="display:none; margin-top: 15px">				
				<h3 style="display: inline"><a href="https://www.opencart.com/index.php?route=extension/purchase&extension_id=2221" target="_blank" style="text-decoration:none"><?php echo $heading_update; ?></a></h3>
				- <p style="display: inline" class="info"></p>						
			</div>
			
			<div class="support">
				<h3 style="display: inline"><a href="<?php echo $docs_url; ?>" target="_blank" style="text-decoration:none">Documentation</a></h3>				
...
(function($){	
	...
	$("#template_list").delegate("tr[data-href]", "dblclick", function(e){
