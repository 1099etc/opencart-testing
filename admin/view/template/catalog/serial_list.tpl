				...
				<table class="list">
					<thead>
						<tr>
							...
							<td class="right"><?php echo $column_keys; ?></td>
...
<?php foreach ($serials as $serial) { ?>
						<tr>
							...
							<td class="left"><?php echo $serial['name']; ?></td>
							<td class="right"><?php echo $serial['text']; ?></td>
							<td class="center"><a href="index.php?route=catalog/serial/edit&amp;id=<?php echo $serial['id']; ?>&amp;token=<?php echo $this->session->data['token']; ?>">[<?php echo $text_action; ?>]</a></td>
						</tr>
<?php } ?>
<?php } else { ?>
						<tr>
							<td class="center" colspan="4"><?php echo $text_no_keys; ?></td>
						</tr>
<?php } ?>
					</tbody>
				</table>
