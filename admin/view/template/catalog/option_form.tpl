    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            <td><span class="required">*</span> <?php echo $entry_featurecodeOrder; ?></td>
            <td><input type="text" name="featurecodeOrder" value="<?php echo $featurecodeOrder; ?>" size="1" /></td>
          </tr>
        ...
        <table id="option-value" class="list">
          <thead>
            <tr>
              ...
              <td class="right"><?php echo $entry_featurecode  ?></td>
          ...
          <tbody id="option-value-row<?php echo $option_value_row; ?>">
            <tr>
              ...
              <td class="right"><input type="text" name="option_value[<?php echo $option_value_row; ?>][featurecode]" value="<?php echo $option_value['featurecode']; ?>" size="10" /></td>
...
function addOptionValue() {
	...
	html += '    <td class="right"><input type="text" name="option_value[' + option_value_row + '][featurecode]" value="" size="1" /></td>';
