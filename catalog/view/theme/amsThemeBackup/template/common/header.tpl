...
<div id="header">
  <?php if ($logo) { ?>
  <div id="logo"><a href="http://www.advancedmicrosolutions.net/wordpress/"><img src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" /></a></div>
  <?php } ?>
  <?php echo $language; ?>
  <?php echo $currency; ?>
  <?php echo $cart; ?>
  ...
  <div class="links">
    <a href="http://www.advancedmicrosolutions.net/wordpress/"><?php echo $text_home; ?></a>
