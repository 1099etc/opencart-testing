...
<div id="content"><?php echo $content_top; ?>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <table class='content' style='width:100%' cellspacing='10'>
     <?php if($errors) { ?>
       <tr><td colspan='2' style='color: red;'><?php echo $errors; ?></td></tr>
     <?php } ?>
     <tr>
        <td width='50%' ><label for='serial'>Serial Number (All 8 characters are required)</label></td>
        <td><input type='text' name='serial' id='serial' class='textbox uppercase' value='<?php echo $serial; ?>' /></td>
      </tr>
      <tr>
