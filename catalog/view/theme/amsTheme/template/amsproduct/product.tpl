...
<div id='controlBoard'>
  <div id='laserGenerationBlock' style='display: block; border: 1px solid lightgrey; padding: 10px; margin: 10px; width:auto;'>
    ...
    <label for='selectLaser' style='font-weight: bold;'>Laser Generation</label>
    <div class='priceTag' style='font-weight: bold; font-size: 14px; display: inline-block; float:right; text-align: right;'>+ $75</div>
    <div class='descriptiveText' style='padding-top: 10px;'>With Laser Generation, you can print the employer/payer and employee/recipient copies on plain white paper. No need to buy preprinted forms. The only forms you will need to purchase are Copy A of the 1099, and the 1096. If you file electronically, you can even eliminate the cost of Copy A forms.</div>
  </div>
