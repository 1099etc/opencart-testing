...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <?php } ?>
    <div class="right">
      <div class="description" style='visibility: hidden; display: none;'>
        <?php if ($manufacturer) { ?>
...
<div id='controlBoard'>
  <div id='laserGenerationBlock' style='display: block; border: 1px solid lightgrey; padding: 10px; margin: 10px; width:auto;'>
    ...
    <label id='selectLaserLabel' for='selectLaser' style='font-weight: bold;'>Software Generated Forms</label>
  ...
  <div id='amsPayrollBlock' style='display: block; border: 1px solid lightgrey; padding: 10px; margin: 10px; width:auto;'>
    ...
    <label id='selectAMSpayrollLabel' for='selectAMSpayroll' style='font-weight: bold;'>AMS Payroll</label>
