...
class ControllerAccountForgotten extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$html = "<p>".sprintf($this->language->get('text_greeting'), $this->config->get('config_name'))."</p>";
      $message .= $this->language->get('text_password') . "\n\n";
			$html .= "<p>". $this->language->get('text_password')."</p>";
      $message .= $password . "\n\n";;
      $html .= "<p>".$password."</p>";
      $message  = sprintf($this->language->get('text_change')) . "\n\n";
      $html .= "<p><b>". $this->language->get('text_change')."</b></p>";
      $message  = sprintf($this->language->get('text_thanks')) . "\n\n";
