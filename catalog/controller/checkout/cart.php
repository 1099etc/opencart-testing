...
class ControllerCheckoutCart extends Controller {
    ...
    if (isset($this->request->get['empty'])) {
      ...
      $this->data['button_empty_cart'] = $this->language->get('button_empty_cart');	
      ...
      $this->data['checkout'] = $this->url->link('checkout/checkout', '', 'SSL');
      // add for empty cart button
      $this->data['empty'] = $this->url->link('checkout/cart', 'empty=1', 'SSL');			
	...
	public function quote() {
		...
		if ($country_info && $country_info['postcode_required'] && (utf8_strlen($this->request->post['postcode']) < 4) || (utf8_strlen($this->request->post['postcode']) > 10)) {
